...
def main():
    ...
    parser = ArgumentParser(
        description='compare the diag files written by varDA.py',
    ...
    fnames = []
    for i in range(nf):
        fnames.append(fname + '%3.2f.nc4' % ((alpha[i])))
