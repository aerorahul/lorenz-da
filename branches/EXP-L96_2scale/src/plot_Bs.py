...
parser = ArgumentParser(description = 'Plot climatological covariances for LXX models', formatter_class=ArgumentDefaultsHelpFormatter)
parser.add_argument('-m','--model',help='model name',type=str,choices=['L63','L96'],default='L96',required=False)
parser.add_argument('-f','--filename',help='file with climatological covariances',type=str,required=True)
