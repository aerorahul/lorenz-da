...
def main():
    ...
    ylabstr  = '$\delta J$'
    fig1 = plot_ObImpact(adJ_sm,edJ_sm,title=titlestr,xlabel=xlabstr,ylabel=ylabstr)

    titlestr = '$\delta J_a$'
    xlabstr  = 'Assimilation Step'
    ylabstr  = '$\delta J_a$'
    fig2 = plot_ObImpact(adJa_sm,edJa_sm,title=titlestr,xlabel=xlabstr,ylabel=ylabstr)

    titlestr = '$\delta J_b$'
    xlabstr  = 'Assimilation Step'
    ylabstr  = '$\delta J_b$'
    fig3 = plot_ObImpact(adJb_sm,edJb_sm,title=titlestr,xlabel=xlabstr,ylabel=ylabstr)
