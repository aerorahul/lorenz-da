...
def main():
    ...
    parser = ArgumentParser(
        description='Compute climatological covariances for LXX models',
    ...
    if ((method == 'NMC') or (method == 'Climo')):
        ...
        # how long to run onto the attractor
        ts = np.arange(0.0, ts + model.dt, model.dt)
